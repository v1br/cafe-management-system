          ...
          <>
            ...
            <div className="mt-8 mx-4 p-4 bg-gray-100 rounded-lg shadow-md">
              <p className="text-lg font-medium">
				...
				<button
					onClick={() => alert("Thank you for placing an order!\n\n{This is a dummy alert, to be redirected to the external payment portal via backend microservice...}")} // Dummy alert
